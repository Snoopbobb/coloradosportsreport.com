<?php
/**
 * CSR-Theme functions and definitions
 *
...
if ( ! defined( 'CSR_THEME_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	define( 'CSR_THEME_VERSION', '1.0.0' );
}

if ( ! function_exists( 'csr_theme_setup' ) ) :
	/**
	...
	function csr_theme_setup() {
		 ...
		 * If you're building a theme based on CSR-Theme, use a find and replace
		 * to change 'csr-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'csr-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'csr-theme' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'csr_theme_custom_background_args',
				array(
...
function csr_theme_widgets_init() {
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'csr-theme' ),
...
add_action( 'widgets_init', 'csr_theme_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'csr_theme_scripts' );
